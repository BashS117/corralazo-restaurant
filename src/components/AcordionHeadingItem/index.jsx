...
const AcordionHeadingItem = ({category,categoryImg,index,handlePanelOpen,rightPanel,isPanelOpen}) => {
  ...
  return (
    <div className={`${rightPanel? 'h-[120px]':'h-[90px]'} items-center p-[5px] flex justify-between mb-[10px]  border-[1px] border-orange rounded-lg shadow-lg`} onClick={handleClick} >
